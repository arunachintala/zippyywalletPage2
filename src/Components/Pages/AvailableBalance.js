...
import group from './Group 148.svg'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', width: '100%' }}>
                ...
                <div style={{ border: '1px solid #D9D9D9', marginTop: '5%', padding: '5%', borderRadius: '16px', backgroundColor: '#FFFFFF' }}>
                    ...
                    <div style={{
                        ...
                        <p style={{ fontFamily: 'Poppins', fontWeight: '400', fontSize: '12px', lineHeight: '20.52px', color: '#121114' }}>Wallet recharge for amount 500 $ was successful.</p>
                    </div>
                    <p style={{
                        fontWeight: 400,
                        lineHeight: '18px',
